...
export default class PlaylisterController {
    ...
    updateAddPlaylistButtonState() {
        const addListButton = document.getElementById("add-playlist-button");
    ...
    updateCloseListButtonState() {
        const addListButton = document.getElementById("close-button");
        if (!this.model.hasCurrentList()) {
            addListButton.disabled = true;
            addListButton.classList.add("disabled");
        } else {
    ...
    registerStaticHandlers() {
        ...
        // HANDLES CREATING A NEW EMPTY PLAYLIST
        const addListButton = document.getElementById("add-playlist-button");
        if (addListButton) {
            addListButton.onmousedown = (event) => {
        ...
        this.updateCloseListButtonState();
    }
    ...
    registerModalHandlers() {
        ...
        // RESPOND TO THE USER CANCELING SONG REMOVAL
    ...
    registerSongCardHandlers() {
        ...
        for (let i = 0; i < this.model.getPlaylistSize(); i++) {
            ...
            removeSongButton.onclick = (event) => {
                ...
                let song = this.model.getSong(songIndex);
                let removeSongTitleSpan = document.getElementById("remove-song-title-span");
                removeSongTitleSpan.innerHTML = song.title;
